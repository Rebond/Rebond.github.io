...
$(function()
{
	...
	if($.isFunction($.fn.countup))
	{
		$('.meetTime[data-date]').countup(
		{
			...
			render: function(data)
			{
				$(this.el).html
				(
					//"<div class=\"countdown-box countdown-box1\"><h2 class=\"countdown-number\">" + data.years + "</h2>" + " <h4 class=\"countdown-title\">年</h4></div>" +
					"<div class=\"countdown-box countdown-box1\"><h2 class=\"countdown-number\">" + Number(Number(data.years*365)+Number(data.days)) + "</h2>" + " <h4 class=\"countdown-title\">天</h4></div>" +
					"<div class=\"countdown-box countdown-box1\"><h2 class=\"countdown-number\">" + data.hours + "</h2>" + " <h4 class=\"countdown-title\">时</h4></div>" +
					"<div class=\"countdown-box countdown-box1\"><h2 class=\"countdown-number\">" + this.leadingZeros(data.min, 2) + "</h2>" + " <h4 class=\"countdown-title\">分</h4></div>" +
					"<div class=\"countdown-box countdown-box1\"><h2 class=\"countdown-number\">" + this.leadingZeros(data.sec, 2) + "</h2>" + " <h4 class=\"countdown-title\">秒</h4></div>"
				);
			}
		});
	}
	...
	if($.isFunction($.fn.countdown))
	{
		$('.huangBirthday[data-date]').countdown(
		{
			date: $(this).data('date'),
			render: function(data)
			{
	...
	if($.isFunction($.fn.countdown))
	{
		$('.jianmianTime[data-date]').countdown(
		{
			date: $(this).data('date'),
			render: function(data)
			{
